...
const EMPLOYEES = [
  { enrollId: '570884', name: 'Nasim Ahmed Maruf', designation: 'LearningLab Team Head & Manager - Training & Development', department: 'LearningLab (Training & Development)', status: 'Probationary Employee', phone: '01886545433', dob: '10/6/1988', bloodGroup: 'B+', email: 'nasimahmed@nextjobz.work', role: 'training_mgr' },
  { enrollId: '571638', name: 'Md Mafizul Islam Muhin', designation: 'Headhunting & Recruitment Manager', department: 'Headhunting & Recruitment', status: 'Probationary Employee', phone: '01794589116', dob: '1/1/1990', bloodGroup: 'B+', email: 'md.mafizulislam@akijresource.com', role: 'headhunting_mgr' },
  ...
  { enrollId: '569194', name: 'Tazul Islam Rabby', designation: 'Manager - Government & Public Training', department: 'Government & Public Training', status: 'Probationary Employee', phone: '01725786924', dob: '12/8/1991', bloodGroup: 'O-', email: 'rabby@nextjobz.work', role: 'admin' },
  { enrollId: '570731', name: 'Md Rubel Hossain', designation: 'Officer, Business Development & Strategic Operations', department: 'Operations', status: 'Probationary Employee', phone: '01521202170', dob: '4/16/1994', bloodGroup: 'O+', email: 'md.rubelhossain@nextjobz.work', role: 'admin' },
  ...
  { enrollId: '568058', name: 'Md. Naimur Rahman', designation: 'Assistant Manager', department: 'Product & Technology', status: 'Regular Employee', phone: '01300772607', dob: '9/24/1998', bloodGroup: 'A+', email: 'naimur@nextjobz.work', role: 'admin' },
  ...
  { enrollId: '571739', name: 'Sangida Jahan Ripa', designation: 'Intern', department: 'Finance & Operations', status: 'Intern', phone: '01994003814', dob: '9/29/2002', bloodGroup: 'A+', email: 'ripa@nextjobz.work', role: 'admin' },
  ...
  { enrollId: '571781', name: 'Md. Mahbubul Hasan', designation: 'Officer - Learning & Development', department: 'Learning & Development', status: 'Probationary Employee', phone: '01785688651', dob: '3/3/1998', bloodGroup: 'O-', email: 'md.mahbub@nextjobz.work', role: 'training_officer' },
  ...
  { enrollId: '572550', name: 'Sanjida Islam', designation: 'Intern - Business Development & Recruitment', department: 'Business Development', status: 'Intern', phone: '01315509277', dob: '12/31/2003', bloodGroup: 'A+', email: 'sanjida@nextjobz.work', role: 'business_development' }
];
